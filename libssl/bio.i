...
%apply (const unsigned char *inbuf) {const unsigned char *key, const unsigned char *iv}
...
//
%apply (char *OUTCHARBUF, int len) {(char *outbuf, int size)}
int BIO_gets(BIO *b, char *outbuf, int size);
